...
$("#fecha_fin").on("change", function(){
    ...
    {
        $('#result_f_f_error').text("");
        $('#result_f_f').removeClass('has-error').addClass('has-success');
        $('#result_f_i').removeClass('has-error').addClass('has-success');
    }else{
        $("#fecha_fin").val("");
        $('#result_f_f_error').text("Fecha incorrecta");
        $('#result_f_f').removeClass('has-success').addClass('has-error');
        $('#result_f_i').removeClass('has-error').addClass('has-success');
    }
});
...
$("#fecha_inicio").on("change", function(){
    ...
    if(fechaFinal!=""){
        if(validate_fechaMayorQue(fechaInicial,fechaFinal))
        {
            ...
            $("#fecha_fin").val("");
            $('#result_f_f_error').text("Fecha incorrecta");
            $('#result_f_').removeClass('has-success').addClass('has-error');
        }
    }
});
