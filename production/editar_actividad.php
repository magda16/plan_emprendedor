...
$nivel_usu=$_SESSION['nivel'];
  ...
  if(isset($_POST['id'])){
    $id_actividad=$_POST['id'];
        ...
        $stmt= $pdo->prepare("SELECT id_actividad, nombre, DATE_FORMAT(fecha_inicio, '%d/%m/%Y') AS fecha_inicio, DATE_FORMAT(fecha_fin, '%d/%m/%Y') AS fecha_fin, hora_inicio, hora_fin, descripcion, estado FROM actividad WHERE id_actividad=:id_actividad");
        $stmt->bindParam(":id_actividad",$id_actividad,PDO::PARAM_INT);
        $stmt->execute();
        $result=$stmt->fetchAll(PDO::FETCH_ASSOC);
        foreach($result as $lista_actividad){     
            $nombre_actividad_r=$lista_actividad['nombre'];
            $fecha_inicio_r=$lista_actividad['fecha_inicio'];
            $fecha_fin_r=$lista_actividad['fecha_fin'];
            $hora_inicio_r=$lista_actividad['hora_inicio'];
            $hora_fin_r=$lista_actividad['hora_fin'];
            $descripcion_r=$lista_actividad['descripcion'];
        }
  }else{
                ...
                <div class="x_panel">
                  ...
                  <br />
                    ...
                    <form id="form_actividad" name="form_actividad" method="POST" class="form-horizontal form-label-left">
                      ...
                      <input type="hidden" id="actualizar" name="actualizar" value="<?php echo $id_actividad; ?>" >
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control has-feedback-left" id="nombre_actividad" name="nombre_actividad" required="required" placeholder="Ingrese Nombre Actividad" value="<?php echo $nombre_actividad_r; ?>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" class="form-control has-feedback-left" id="fecha_fin" name="fecha_fin" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $fecha_fin_r; ?>">
                          <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                        </div>
                        <span class="help-block"></span>
                      </div>
                          ...
                          <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <span class="input-group-addon">
                                    ...
                                    <input type="text" class="form-control" id="hora_inicio" name="hora_inicio" required="required" value="<?php echo $hora_inicio_r; ?>"/>
                                </div>
                                <span class="help-block"></span>
                            </div>
                          ...
                          <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <span class="input-group-addon">
                                    ...
                                    <input type="text" class="form-control" id="hora_fin" name="hora_fin" required="required" value="<?php echo $hora_fin_r; ?>"/>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="descripcion" name="descripcion" class="form-control col-md-7 col-xs-12" required="required" placeholder="Ingrese Descripción"><?php echo $descripcion_r; ?></textarea>
                        </div>
                        <span class="help-block" ></span>
                      </div>
