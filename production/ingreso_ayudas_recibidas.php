                  ...
                  <br />
                    ...
                    <form id="form_ayuda_recibida" name="form_ayuda_recibida" method="POST" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control has-feedback-left" id="nombre_cooperante" name="nombre_cooperante" required="required" placeholder="Ingrese Nombre">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control has-feedback-left" id="monto" name="monto" required="required" placeholder="Ingrese Dirección">
