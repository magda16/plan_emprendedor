...
<html lang="es">
  ...
  <body class="nav-md">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li><a data-toggle="tooltip" data-placement="top" title="Agregar Institución" href="ingreso_institucion.php"><i class="fa fa-plus-circle"></i></a>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <form id="from_editar_institucion" name="from_editar_institucion" action="editar_institucion.php" method="POST">
                      <input type="hidden" id="id" name="id">
                    </form>

                    <form id="from_mostrar_institucion" name="from_mostrar_institucion" action="mostrar_institucion.php" target="_blank" method="POST">
    ...
    <script src="../build/js/validaciones/list_institucion.js"></script>
