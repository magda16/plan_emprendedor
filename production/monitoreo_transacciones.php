...
<html lang="es">
  ...
  <body class="nav-md">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h2><i class="fa fa-folder-open-o"></i> Transacciones</h2>
              </div>
            </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="col-xs-3">
                      ...
                      <ul class="nav nav-tabs tabs-left">
                        <li class="active"><a href="#home" data-toggle="tab">Yo</a>
                        </li>
                        <li><a href="#profile" data-toggle="tab">Recurso a Cargo</a>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div class="col-xs-9">
                      ...
                      <div class="tab-content">
                        <div class="tab-pane active" id="home">
                          ...
                          <p>Administrador del Sistema Plan Emprendedor</p>
                        </div>
    ...
    <script src="../build/js/validaciones/list_bitacora.js"></script>
