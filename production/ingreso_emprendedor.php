            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <form id="form_demandante" name="form_demandante" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <h3><strong>Paso 4: <small>Datos del Emprendimiento</small></strong></h3>
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12 text-left" for="actividad_eco">Actividad Económica:
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" class="form-control has-feedback-left" id="actividad_eco" name="actividad_eco" required="required" placeholder="Ingrese Actividad Económica">
                              <span class="fa fa-circle-o form-control-feedback left" aria-hidden="true"></span>
                            </div>
                            <span class="help-block"></span>
                          </div>
                        ...
                        <h3><strong>Paso 9: <small>Situación Legal</small></strong></h3>
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="matricula_comercio">Matricula de Comercio:
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" class="form-control has-feedback-left" id="matricula_comercio" name="matricula_comercio" required="required" placeholder="Ingrese Matricula de Comercio">
                              <span class="fa fa-list-alt form-control-feedback left" aria-hidden="true"></span>
                            </div>
                            <span class="help-block"></span>
                          </div>
